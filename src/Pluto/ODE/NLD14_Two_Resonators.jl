...
let
    ...
    plot(spectrum.freq, 10 .* log10.(max.(relative_power, 1e-10));
        xlims=(0, 20*f0), ylims=(-80, 0), xlabel="frequency (Hz)", ylabel="relative power (dB)", legend=false)
end
...
md"""
This is the sum of the two modal pressures after the transient.
...
# ╔═╡ 1ccca242-e2d7-5a77-8a2a-35feaea721f3
md"""
