...
Start with NLD01 and follow the lesson numbers; use sliders to explore the dynamics before examining the code.
...
- [NLD01_Maps](NLD01_Maps.jl)
- [NLD02_Flows1D](NLD02_Flows1D.jl)
