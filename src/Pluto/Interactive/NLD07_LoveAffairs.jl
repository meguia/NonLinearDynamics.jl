...
where $a$ and $b$ specify Romeo’s “romantic style,” and $c$ and $d$ specify Juliet’s style. The parameter $a$($d$) describes the extent to which Romeo (Juliet) is encouraged by his(her) own feelings, and $b$($c$) is the extent to which he is encouraged by his(her) partner feelings.
...
As can be seen also in the 2D flows, a homogeneous linear system has a single fixed point at the origin when its matrix is invertible. A singular matrix has a line or plane of equilibria.
...
We can represent the four parameters $a,b,c,d$ in the form of a matrix.
...
function romanticlass(pars,name1,name2,heshe1,heshe2)
	...
	if (d>0)
		...
		if (c>0)
			...
			jtitle = "$name2 (HERMIT) retreats from $hisher2 own feelings as well as $(name1)’s"
		end
	end
...
# ╔═╡ 484089d6-3a0e-55ae-9021-660fa2db910f
md"""
...
# ╔═╡ 9608174f-2c77-53d9-9663-cef63a2fa6a5
...
# ╔═╡ d2755426-efd5-5fe4-a16a-7cc65a71d4bb
...
# ╔═╡ bd39addf-5d63-5079-947e-7ec8ff29488f
md"""
Example: $(@bind course_linear_choice Select(["Stable node","Saddle","Stable focus","Center","Transient growth"];default="Stable focus"))
"""

# ╔═╡ f128a761-2630-5f22-b307-e1275239cc13
course_linear_u0 = [0.0,1.0]

# ╔═╡ 8da2f0d8-f294-5d4e-b499-1a6f4dfb18c3
course_linear_tspan = (0.0,12.0)

# ╔═╡ 7ed33131-7056-5fed-aad7-0662d61dd609
course_linear_p = course_matrices[course_linear_choice]

# ╔═╡ e2654663-a47e-5cc0-a50d-8e8aa03fb553
course_linear_prob = ODEProblem(course_linear!, course_linear_u0, course_linear_tspan, course_linear_p)

# ╔═╡ 4c64238a-15be-54a7-acc8-99a5aff371d5
course_linear_sol = solve(course_linear_prob, Tsit5(); abstol=1e-9, reltol=1e-8);

# ╔═╡ 83e3249c-94ba-579d-8f70-baed190747cf
classification_linear(course_linear_p;Ngrid=3,tmax=2.0)

# ╔═╡ f69b7e1d-0615-5db9-929a-2d76cca22ad6
...
# ╔═╡ ccf4e663-96d5-5ec0-bfb4-d0529af39147
...
# ╔═╡ 8d49a63a-94d9-513d-af0b-ade757d2701a
md"""
