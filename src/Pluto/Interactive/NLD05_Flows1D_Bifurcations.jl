...
A fixed point can be **stable** (or **atractor**) if the trajectories converge to it from the left and the right, or **unstable** (i. e. **repulsor**) if the trajectories diverge to both sides. A point attracting from only one side is **semistable**.
...
The second step is to determine the stability of the fixed points. This can be done by finding the slope of the function at the fixed point (or equivalently the **derivative of f with respect to x** at that point which we will denote using a prime instead of a dot $f'(x_*)$):
...
- If the slope is **zero**, linearization does not determine stability: the fixed point may be stable, unstable, or semistable. In this case it may happen, but not always, that the function tangentially touches the horizontal axis, in that case any slight perturbation of the shape of the function (later we will define what that means in a more formal way) either generates two fixed points (one stable and one unstable), or causes there to be no fixed point. Later we will see that this is linked to a type of change in the topology of the flow called repulsor-attractor bifurcation.
...
# ╔═╡ 24dc048b-d6a6-50bb-8f1f-140f66fe4408
md"""
...
# ╔═╡ 0707982a-2378-5273-84f7-7525653635c7
...
# ╔═╡ 36f0d4cb-c619-5e04-8fc0-a22087d352d6
md"""
Form: $(@bind course_kind Select([1=>"Saddle-node",2=>"Transcritical",3=>"Pitchfork"]; default=3))
"""

# ╔═╡ 1d8bf054-e8fe-5b03-9516-ead27ddf80ef
md"""
μ: $(@bind course_mu Slider(-0.5:0.02:0.5; default=0.2, show_value=true))
"""

# ╔═╡ 68f3ac94-c6fe-55f2-b1d0-28219144beb8
course_normal_u0 = [0.15]

# ╔═╡ cd04fd00-a3ec-59eb-8a6d-828ed0879ccd
course_normal_tspan = (0.0,25.0)

# ╔═╡ 9a4062fa-9593-5a2b-891f-4f3f7d3bcb77
course_normal_p = [course_mu,course_kind]

# ╔═╡ ab13d425-845a-5d06-be77-6d73ff409275
course_normal_prob = ODEProblem(course_normal_form!, course_normal_u0, course_normal_tspan, course_normal_p)

# ╔═╡ e6047934-41f5-5927-a650-f57cc9ad1ef0
...
# ╔═╡ a09327bf-2b0e-5a95-a17c-d4d11222be0c
...
# ╔═╡ a1bf902e-1b8d-589b-8f1b-2ffe9df8280e
...
# ╔═╡ ebc1e4c1-a69b-5f5d-98dc-1b315d88721e
md"""
