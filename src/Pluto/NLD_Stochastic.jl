...
begin
	...
	for e1 = e1g
		...
		while mm>0 
			...
			x0 = maximum([p.interval.lo for p in pp]) # repulsor
			solt = solve(SDEProblem(lff, noise, [x0+0.1, 0.0], (0.0, 300.0),[e1,e2v,0]),saveat=1.0)
...
manifest_format = "2.0"
project_hash = "36861c50fba60cd34eb0a6d7aa8f431bde89c3d8"
